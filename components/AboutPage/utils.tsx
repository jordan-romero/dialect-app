...
export const coaches: Coach[] = [
  {
    ...
    longBio: (
      <Box>
        <Text>
          I’ve done funny voices all my life. In college, I figured out I might
          be able to put that to some good use when a new professor in my
          theater department introduced me to the International Phonetic
          Alphabet (IPA). It was shocking to me that I was able to put the silly
          voices in my head into text -- it was even more shocking when I moved
          to LA and realized this approach is not something most film actors are
          familiar with. <strong>I aim to change that.</strong>
        </Text>
        <Text mt="3">
          ...
          dialect, or even in the decision to add a dialect to their resume. My
          goal is to give actors the tools to analyze, criticize, and most
  ...
  },
  {
    ...
    longBio: (
      <Box>
        <Text>
          I’ve <strong>coached voices and dialects at numerous theaters</strong>{' '}
          ...
          among others. Besides private voice coaching, I worked in the De-Cruit
          program which utilizes Shakespeare’s texts and actor training
          techniques to help military veterans who have experienced trauma. I’ve
          directed and taught dialects, voice and performance courses at Ithaca
          College, University of Connecticut, Syracuse University, University of
          Mississippi, and The American University in Cairo.
        </Text>
        <Text mt="3">
